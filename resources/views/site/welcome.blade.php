        ...
        <div class="col-md-9">
            ...
            <form id="uploadForm" enctype="multipart/form-data">
                ...
                <div class="row fimBtns">
                    ...
                    <div class="col-md-4 col-sd-6">
                        <button type="button" id="processButton" class="btn btn-dark mt-3 mb-3 w-100"><i class="fa-solid fa-cart-shopping"></i>
                            Enviar</button>
                    </div>
            ...
            <div class="modal fade" id="modalEscolha" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
    ...
    function handleFiles(files) {
        ...
        files.forEach(function (file, i) {
            ...
            reader.onload = function (e) {
                ...
                const $deleteButton = $('<button>').attr('type', 'button').addClass('btn btn-danger mt-2 text-center').html('<i class="fa-solid fa-trash"></i>').on('click', function () {
                    $wrapper.remove();
                    updateTotalPedido();
                });

                const $controls = $('<div>').addClass('image-controls text-center').append($deleteButton);

                $atributos.append($sizeLabel, $sizeSelect, $quantityLabel, $quantityInput, $priceLabel, $priceSpan, $priceInput, $subtotal);
